...
public class _12_Hit_API_With_ValidToken {
	...
	public void TC_11_HitSecuredAPI() {
		...
		/**
		 * We are not allowed to get the Code by Automation
		 * as Google has blocked Automation for Gmail Sign in
		 * 
		 * Go to hit_Browser_AndGetCodeValue_FromURL() 
		 */
		String codeValue ="4%2F0AX4XfWgbpJVUWVWxIzISs9MwybZPAzSTAFLzkHSO4fSnLTiL6r8e8AxpOcTuKUBC7IHSDg";
		 ...
		 * access_token=ya29.a0ARrdaM-b7XcElzTcQiuiWPMghUR1EGa4877yyTXLISkMqWxp9xtZ9RZATI8GE6MfOuPCXpqLl4v-GWO9l5lUgdcNeGtOY0YEegjiXGoSEmqAwI32Rp3ddu6lVRTI96ElCbUG8Toq0fqoeg5rA1TpCfZQbqlu
		 */
	...
	private String hitGET_Req_ToGetAccessToken(String codeValue) {
		 ...
		 * code=4%2F0AX4XfWhfXGKYAYVLksD8kPOiZWMTTV7o2Cp2SwYfk_hgXEJyI-oZUQa_kodwVyREIzHboA
		...
		/**
		  	Client: BookMyShow
			Client ID: ID that identifies the Client
			Client secret ID: BookMyShow registers with Google
		...
		Response response1 = given().log().all().
			...
			//queryParam("code", "4%2F0AX4XfWgbpJVUWVWxIzISs9MwybZPAzSTAFLzkHSO4fSnLTiL6r8e8AxpOcTuKUBC7IHSDg").
	...
	private String hit_Browser_AndGetCodeValue_FromURL() {
		...
		/*You need to hit below URL in Browser get the code value from there
		 * becasue Google has blocked the Automation for Gmail Sign in
		 */
		/*
