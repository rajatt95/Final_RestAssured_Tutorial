...
public class _12_DeSerialization_SoapUI_Course_Price {
	...
	public void TC_11_HitSecuredAPI() {
		 ...
		 */
		String codeValue = "4%2F0AX4XfWgnmcruwLmSwwjmGnR2aiP4Hzd2EW2vGvVUUtRAseGHCi3SBwCzM5LaCtL3HdlmNg";
		...
		for (int i = 0; i < listOfWebAutomationCourses.size(); i++) {
			System.out.println("listOfWebAutomationCourses.get(" + i + ").getCourseTitle(): " + listOfWebAutomationCourses.get(i).getCourseTitle());
			System.out.println("listOfWebAutomationCourses.get(" + i + ").getPrice(): " + listOfWebAutomationCourses.get(i).getPrice());
		}
		System.out.println("************************************************************************");
		List<API> listOfAPICourses = getCourse.getCourses().getApi();
		for (int i = 0; i < listOfAPICourses.size(); i++) {
			System.out.println("listOfAPICourses.get(" + i + ").getCourseTitle(): " + listOfAPICourses.get(i).getCourseTitle());
			System.out.println("listOfAPICourses.get(" + i + ").getPrice(): " + listOfAPICourses.get(i).getPrice());
		}
		System.out.println("************************************************************************");
		List<Mobile> listOfMobileCourses = getCourse.getCourses().getMobile();
		for (int i = 0; i < listOfMobileCourses.size(); i++) {
			System.out.println("listOfMobileCourses.get(" + i + ").getCourseTitle(): " + listOfMobileCourses.get(i).getCourseTitle());
			System.out.println("listOfMobileCourses.get(" + i + ").getPrice(): " + listOfMobileCourses.get(i).getPrice());
		}
		System.out.println("************************************************************************");
