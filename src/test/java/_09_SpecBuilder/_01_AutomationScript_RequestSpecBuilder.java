...
public class _01_AutomationScript_RequestSpecBuilder {
	...
	public void TC_01_PostRequest_Headers_QueryParam_RequestBody_Assertion_ResponseStatusCode() {
		...
		String place_id = hit_POST_Req_And_Get_PlaceID(requestSpecBuilder);

		hit_GET_Using_PlaceID(requestSpecBuilder,place_id);

	}

	private void hit_GET_Using_PlaceID(RequestSpecification requestSpecBuilder, String place_id) {
...
//					header("Content-Type", "application/json").
	...
	private String hit_POST_Req_And_Get_PlaceID(RequestSpecification requestSpecBuilder) {
